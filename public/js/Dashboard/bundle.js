          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 5;
                return fetch("/rominteach-admin-private/login", {
                  method: "POST",
                  headers: {
...
var team = function team() {
  var imgLoading = document.querySelector(".loading-container");
  var teamNames = document.querySelector("#name");
  var profession = document.querySelector("#profession");
  var teamCreateBtn = document.querySelector(".main-contactus__btn.btn");
  var careerCreateBtn = document.querySelector(".main-contactus__btn-career.btn");
  var teamId = "";
  var careerId = ""; //team create part

  if (teamCreateBtn) {
    teamCreateBtn.addEventListener("click", function (e) {
      if (e.target.innerText === "Create") {
        ...
        if (document.querySelector("#photo").files[0]) {
          var _photo = document.querySelector("#photo").files[0];

          _form.append("photo", _photo);
        }

        _form.append("name", teamNames.value);

        _form.append("profession", profession.value);

        _form.append("id", teamId);

        createSetting(_form, "update", "updateTeam");
      }
    });
  }
  ...
  function () {
    var _ref = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee(form, type, link) {
      var url, fetchBody, res, _data, _url, _fetchBody, _res, _data2;
          ...
          switch (_context.prev = _context.next) {
            ...
            case 12:
              ...
              if (_data.status = "success") {
                showAlert("success", _data.data.message);
                window.setTimeout(function () {
                  location.reload(true);
                }, 1500);
              }
            ...
            case 34:
              ...
              if (_data2.status = "success") {
                showAlert("success", _data2.data.message);
                window.setTimeout(function () {
                  location.reload(true);
                }, 1500);
              }
      ...
      }, _callee, null, [[4, 16], [26, 38]]);
    }));

    return function createSetting(_x, _x2, _x3) {
      return _ref.apply(this, arguments);
    };
  }(); //update part


  var teamListEdit = document.querySelectorAll(".view-team-edit .edit");

  if (teamListEdit) {
    teamListEdit.forEach(function (item) {
      item.addEventListener("click", function (e) {
        teamId = e.target.id;
        var nameText = e.target.closest(".view-team-list").children[1].children[0].innerText;
        var professionText = e.target.closest(".view-team-list").children[1].children[1].innerText;
        document.querySelector(".view-team-img-image").style.display = "inline-block";
        document.querySelector(".view-team-img-image").src = e.target.closest(".view-team-list").children[0].children[0].src;
  ...
  var JobLevel = document.querySelector("#joblevel");
  var OfferedSalary = document.querySelector("#offeredSalary");
  var ApplyBefore = document.querySelector("#applybefore");
  var Education = document.querySelector("#education");
  var Experience = document.querySelector("#experience");
  var Opening = document.querySelector("#opening");

  if (careerCreateBtn) {
    careerCreateBtn.addEventListener("click", function (e) {
      var data = {
  ...
  var careerListEdit = document.querySelectorAll(".view-career-edit .edit-career");

  if (careerListEdit) {
    careerListEdit.forEach(function (item) {
      item.addEventListener("click", function (e) {
        careerId = e.target.id;

        var _JSON$parse = JSON.parse(e.target.dataset.career),
            jobtitle = _JSON$parse.jobtitle,
            jobdescription = _JSON$parse.jobdescription,
            experience = _JSON$parse.experience,
            joblevel = _JSON$parse.joblevel,
            offeredSalary = _JSON$parse.offeredSalary,
            applybefore = _JSON$parse.applybefore,
            education = _JSON$parse.education,
            _id = _JSON$parse._id;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                imgLoading.style.display = "flex";
                _context2.next = 5;
                return fetch("/rominteach-admin-private/logout");
              ...
              case 8:
                ...
                imgLoading.style.display = "none";
                if (_data3.status = "Success") location.assign("/rominteach-admin-private/");
                _context2.next = 16;
                break;
              ...
              case 13:
                ...
                console.log(_context2.t0); // showAlert("error", "try again");
  ...
  var deleteBtnFunction =
  /*#__PURE__*/
  function () {
    var _ref3 = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee3(e, url) {
      var id, res;
    ...
    return function deleteBtnFunction(_x5, _x6) {
      return _ref3.apply(this, arguments);
    };
  }();

  var teamEditDelete = document.querySelectorAll(".view-team-edit .delete");

  if (teamEditDelete.length > 0) {
    teamEditDelete.forEach(function (item) {
      item.addEventListener("click", function (e) {
  ...
  var careerEditDelete = document.querySelectorAll(".view-career-edit .delete-career");

  if (careerEditDelete.length > 0) {
    careerEditDelete.forEach(function (item) {
      item.addEventListener("click", function (e) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "41447" + '/');
